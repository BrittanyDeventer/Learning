...
function addMarker(place)
{
    ...
    // create listener to open info window on marker click
    ...
    .done(function(data, textStatus, jqXHR) {
        ...
        if  (data !== null){
            ...
            for (var i = 0; i < len; i++) {
                content += "<li> <a href=\"" + data[i].link + "\" target=\"_blank\">" + data[i].title + "</li>";}
            
            content += "</ul>";
            
            if(data.length === 0){
            content = "Slow News Day!";}
        }
    })
